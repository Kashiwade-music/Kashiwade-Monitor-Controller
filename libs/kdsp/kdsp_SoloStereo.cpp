#include "kdsp_SoloStereo.h"

namespace kdsp
{
template <typename SampleType> void SoloStereo<SampleType>::prepare(const juce::dsp::ProcessSpec &spec)
{
    reset();
}

template <typename SampleType>
void SoloStereo<SampleType>::process(const juce::dsp::ProcessContextReplacing<SampleType> &context) noexcept
{
...
template <typename SampleType> void SoloStereo<SampleType>::reset() noexcept
{
    // reset
}
} // namespace kdsp